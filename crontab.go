...
func (s *specSchedule) NextRunTime(t time.Time) time.Time {
	// General approach
	//
...
func (schedule *ConstantDelaySchedule) NextRunTime(t time.Time) time.Time {
	return t.Add(schedule.Delay - time.Duration(t.Nanosecond())*time.Nanosecond)
}

// Next returns the next time this should be run.
func (schedule *ConstantDelaySchedule) NextRunTime2(t time.Time) time.Time {
